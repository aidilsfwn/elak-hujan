...
export function LeaveAdvisor() {
  ...
  const verdict = recommendation ? recommendation.hasCleanWindow ? 'Waktu paling rendah risiko.' : 'Risiko kekal tinggi.' : weather.isLoading ? 'Sedang membaca ramalan.' : 'Tetingkap balik sudah tamat.';
