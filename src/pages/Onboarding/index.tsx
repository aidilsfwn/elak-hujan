...
export function Onboarding() {
  ...
  const next = () => { if (step < 2) return setStep(step + 1); setConfig({ homeLocation: draft.homeLocation!, officeLocation: draft.officeLocation!, morningWindow: draft.morningWindow!, eveningWindow: draft.eveningWindow!, officeDaysPerWeek: draft.officeDaysPerWeek!, unavailableDays: draft.unavailableDays!, rainThreshold: draft.rainThreshold ?? 40, onboardingComplete: true, configVersion: 4 }); navigate('/leave', { replace: true }); };
